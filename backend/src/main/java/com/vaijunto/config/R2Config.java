...
public class R2Config {
 ...
 public record R2Properties(String endpoint,String bucket,String region,String accessKeyId,String secretAccessKey,long maxStorageGb){public boolean configured(){return StringUtils.hasText(endpoint)&&StringUtils.hasText(bucket)&&StringUtils.hasText(accessKeyId)&&StringUtils.hasText(secretAccessKey);}public long maxBytes(){return maxStorageGb*1024L*1024L*1024L;}}
}
